...
$artifacts = @(
    [PSCustomObject]@{
        ...
        Hash = 'D73581DE9A59B92791408F984F70D4CDB12D32FE03994CF39D12D5DC8BB2CD6F'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-optimizer-core-$version.jar"
        Hash = '6C24636949D585D9A77926CED42995E0E3441BC1527A6A1A77F710165C217F2A'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-profiler-$version.jar"
        Hash = '8EDFD98FC2D102D2DB964978F733BB6D5724B80334358AB51D146A890793EB5A'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-profiler-core-$version.jar"
        Hash = '4F4214EDA17E8427B3131C71C68CDFDBA6ADE838910B78523AB9024DF9BDF8F3'
    }
)
