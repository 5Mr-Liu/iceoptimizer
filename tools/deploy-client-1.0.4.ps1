...
$artifacts = @(
    [PSCustomObject]@{
        ...
        Hash = 'E58F057C3E3A9985F8E922BCD98C7BEF8A414F11F9707DBD7A1902282B9F62CB'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-optimizer-core-$version.jar"
        Hash = '6A4E1022E81B5A0BA53DDE83D3A736B937F0853C1E2A9AF6A3452317F5CC8DE4'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-profiler-$version.jar"
        Hash = '3977D5F8824AAA3DD90BF0A5A14DE2D893541951251D37520101B90F9BB786C0'
    },
    [PSCustomObject]@{
        Name = "ice-rlcraft-profiler-core-$version.jar"
        Hash = '68E87F35D77A7E888154EA0FFC660F94FB5E3017FCDB5DE8D7D3FC85B31206AB'
    }
)
